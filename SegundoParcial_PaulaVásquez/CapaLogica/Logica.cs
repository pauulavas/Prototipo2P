...
namespace CapaLogica
{
    public class Logica
    {
        ...
        //-----CINCO
        public OdbcDataReader guardar5(string uno, string dos, string estado)
        {
            return sn.guardar5(uno, dos, estado);

        }

        public OdbcDataReader modificar5(string uno, string dos, string estado)
        {
            return sn.modificar5(uno, dos, estado);
        ...
        //-----SEIS
        public OdbcDataReader guardar6(string uno, string dos, string estado)
        {
            return sn.guardar6(uno, dos, estado);

        }

        public OdbcDataReader modificar6(string uno, string dos, string estado)
        {
            return sn.modificar6(uno, dos, estado);
        ...
        //-----SIETE
        public OdbcDataReader guardar7(string uno, string dos, string estado)
        {
            return sn.guardar7(uno, dos, estado);

        }

        public OdbcDataReader modificar7(string uno, string dos, string estado)
        {
            return sn.modificar7(uno, dos, estado);

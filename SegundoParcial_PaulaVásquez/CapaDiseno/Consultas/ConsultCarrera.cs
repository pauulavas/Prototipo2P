...
{
    public partial class ConsultCarrera : Form
    {
        Logica logica = new Logica();
        public ConsultCarrera()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader mostrar = logica.consulta8("1");
            try
            {
                while (mostrar.Read())
                {
        ...
        private void ConsultCarrera_Load(object sender, EventArgs e)
        {
            Dgv_consulta2.Rows.Clear();
            MostrarTabla();
        }
